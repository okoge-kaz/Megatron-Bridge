...
# model config
HF_CHECKPOINT_DIR=/groups/gag51395/hf_checkpoints/Qwen3-4B-Instruct-2507
MEGATRON_CHECKPOINT_DIR=/groups/gag51395/checkpoints/hf-to-megatron/Megatron-Bridge/Qwen3-4B-Instruct-2507

mkdir -p ${MEGATRON_CHECKPOINT_DIR}

# tokenizer config
TOKENIZER_MODEL=/groups/gag51395/hf_checkpoints/Qwen3-4B-Instruct-2507
