...
ITERATIONS=(400 800 1600 3200 4500 6400 9000 12800 15000 18000 20000 25000)
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/Qwen-3-Swallow-32B-v0.1/tp4-pp1-ct2/LR1.00E-5-MINLR1.00E-6-WD0.1/iter_${FORMATTED_ITERATION}
  HF_CHECKPOINT_SAVE_DIR=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-32B-v0.1/tp4-pp1-ct2/LR1.00E-5-MINLR1.00E-6-WD0.1/iteration_${FORMATTED_ITERATION}
