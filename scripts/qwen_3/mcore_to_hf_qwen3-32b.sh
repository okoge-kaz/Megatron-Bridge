...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/Qwen-3-Swallow-32B-SFT-v0.2/exp2/LR1.00E-5-MINLR1.00E-6-WD0.1/iter_${FORMATTED_ITERATION}
  HF_CHECKPOINT_SAVE_DIR=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-32B-Instruct-v0.2/exp2/tp4-pp1-ct2/LR1.00E-5-MINLR1.00E-6-WD0.1/iteration_${FORMATTED_ITERATION}
