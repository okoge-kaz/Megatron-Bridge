...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/Qwen-3-Swallow-4B/tp2-pp1-ct1/LR2.50E-5-MINLR2.50E-6-WD0.1/iter_${FORMATTED_ITERATION}
  HF_CHECKPOINT_SAVE_DIR=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-4B/tp2-pp1-ct1/LR2.50E-5-MINLR2.50E-6-WD0.1/iteration_${FORMATTED_ITERATION}
