...
upload_base_dir=/home/group_9d80ef/kazuki_fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-14B-v0.2/tp4-pp1-ct1/LR1.50E-5-MINLR1.50E-6-WD0.1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-Swallow-14B-v0.2-CPT-LR1.5E-5-iter${FORMATTED_ITERATION}"
