...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen-3-Swallow-30B-A3B-Instruct-v0.2/exp2/LR1.50E-5-MINLR1.50E-6-WD0.1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-Swallow-30B-A3B-Instruct-v0.2-exp2-LR1.5E-5-iter${FORMATTED_ITERATION}"
