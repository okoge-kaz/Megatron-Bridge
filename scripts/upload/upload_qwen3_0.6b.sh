...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-0.6B-v0.2/tp1-pp1-ct1/LR2.50E-5-MINLR2.50E-6-WD0.1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-Swallow-0.6B-v0.2-CPT-LR2.5E-5-iter${FORMATTED_ITERATION}"
