...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Llama-3.1-8b/swallow-mat-v1/exp3
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Llama-3.1-8B-swallow-math-iclr26-exp3-iter${FORMATTED_ITERATION}"
