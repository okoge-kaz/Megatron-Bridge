...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Llama-3.1-8B/swallow-code/exp13
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Llama-3.1-8B-swallow-code-exp13-iter${FORMATTED_ITERATION}"
