...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-8B-v0.2-SFT/exp1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-Swallow-8B-Instruct-v0.2-exp1-LR1.5E-5-iter${FORMATTED_ITERATION}"
