...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-8B-BF16/tp2-pp1-ct1/LR1.50E-5-MINLR1.50E-6-WD0.1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-Swallow-8B-v0.1-BF16-LR1.5E-5-iter${FORMATTED_ITERATION}"
