...
upload_base_dir=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Qwen3-Swallow-8B-swallow-corpus-v3/gemma/LR1.50E-5-MINLR1.50E-6-WD0.1
...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  repo_name="tokyotech-llm/Qwen3-8B-Swallow-Corpus-v3-gemma-LR1.5E-5-iter${FORMATTED_ITERATION}"
