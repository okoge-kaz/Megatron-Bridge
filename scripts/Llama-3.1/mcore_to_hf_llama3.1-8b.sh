...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/Llama-3.1-8B/swallow-code/exp10/tp1-pp1-ct1/LR2.5E-5-MINLR2.5E-6-WD0.1/iter_${FORMATTED_ITERATION}
  HF_CHECKPOINT_SAVE_DIR=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Llama-3.1-8B/swallow-code/exp10/iteration_${FORMATTED_ITERATION}
