...
# model config
HF_CHECKPOINT_DIR=/groups/gag51395/hf_checkpoints/gpt-oss-120b
MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/hf-to-megatron/Megatron-Bridge/2025-11/gpt-oss-120b
