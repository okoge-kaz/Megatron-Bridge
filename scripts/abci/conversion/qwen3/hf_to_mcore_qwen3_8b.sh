...
MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/hf-to-megatron/Megatron-Bridge/2025-11/Qwen3-8B-Base
mkdir -p ${MEGATRON_CHECKPOINT_DIR}

export CUDA_DEVICE_MAX_CONNECTIONS=1
MEGATRON_LM_PATH=/groups/gch51639/fujii/src/library/Megatron-LM
