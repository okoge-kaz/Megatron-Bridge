...
for ITERATION in "${ITERATIONS[@]}"; do
  ...
  # model config
  HF_CHECKPOINT_DIR=/groups/gag51395/hf_checkpoints/Meta-Llama-3.1-8B-Instruct
  MEGATRON_CHECKPOINT_DIR=/groups/gch51639/fujii/checkpoints/Llama-3.1-8B/sft/exp2/tp2-pp1-ct1/LR2.50E-5-MINLR2.50E-6-WD0.1/iter_${FORMATTED_ITERATION}
  HF_CHECKPOINT_SAVE_DIR=/groups/gch51639/fujii/checkpoints/megatron-to-hf/Llama-3.1-8B/sft/lmsys-chat-1m-gemma3/iteration_${FORMATTED_ITERATION}
